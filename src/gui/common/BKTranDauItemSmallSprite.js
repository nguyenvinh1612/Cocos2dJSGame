 ...
 */
BKTranDauItemSmallSprite = BkSprite.extend({
    parentNode: null,
    tranDauData:null,
    logoTeam1:null,
    logoTeam2:null,
    ...
    initItem: function ()
    {
        ...
        this.bg.setScale(this.WD_WIDTH/this.bg.width,1);
        this.bg.x = this.WD_WIDTH/2;
        this.bg.y = 40;
        this.addChild(this.bg,-1);
        this.bgHover = new cc.Scale9Sprite(res_name.top_bg_hover);
        this.bgHover.setContentSize(cc.size(this.WD_WIDTH, 80));
        ...
        logMessage("w:" + lblChu.getContentSize().height);
