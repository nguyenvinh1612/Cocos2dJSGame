 ...
 */
BkRaiseBetMoney = BkWindow.extend({
    logic:null,
    txtMoney:null,
    betMoney:null,
    ctor: function(money) {
    ...
    initWindow: function ()
    {
        ...
        var rdData2Time = new BkRadioButtonData(3,3,"3");
        var bet3Time = new BkRadioButton(rdData2Time.description);
        bet3Time.setData(rdData2Time);
