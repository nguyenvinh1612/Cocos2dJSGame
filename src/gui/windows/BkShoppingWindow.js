...
SHOPPING_WINDOW_SPACE_ROW = 10;
BkShoppingWindow = BkTabWindow.extend({
    shopItemsData: null,
    ...
    listUIItem:null,
    ctor: function () {
        this._super("Cửa hàng", cc.size(621, 421), this._tabList.length, this._tabList);
        this.initInputData();
        this.initUI();
    ...
    drawItemList: function (itemType){
        ...
        for ( var i = 0, len = listItems.length; i < len; i++ )
        {
            ...
            {
                var itemSprite = new BkShoppingItem(item, this, false, BkGlobal.UserInfo.userName);
                ...
                else if(itemCount% SHOPPING_WINDOW_NUMBER_OF_COLUMNES == 0)
                {
                    ...
                    yPos = yPos - 97 - SHOPPING_WINDOW_SPACE_ROW;
                    xPos = 2 + itemWidth / 2 + SPACE_COLUMN;
                }
                else
                {
