...
var VvLuckyBoxWindow = VvWindow.extend({
    sph: cc.spriteFrameCache,
    listBox: null,
    selectedBox: -1,
    textMsg: null,
    ctor: function (parentNode) {
        this._super("Chiếc hộp may mắn", cc.size(680, 430), parentNode);
    ...
    upLuckyBoxWindow: function (requestBoxReturn) {
        ...
        if (requestBoxReturn.luckyResult == 0) {
            ...
            this.textMsg.setTextColor(cc.color(255, 255, 0));
            ...
            textNotice.setTextColor(cc.color(255, 255, 0));
